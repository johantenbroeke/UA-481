...
/**
 * Base configuration for the Firecontrol controller. 
 */
function Firecontrol(documentInterface, camDocumentInterface) {
    LaserBase.call(this, documentInterface, camDocumentInterface, false);
...
Firecontrol.prototype = new LaserBase();
Firecontrol.displayName = "";
