 ...
 */
function GCodeOffsetMM(documentInterface, camDocumentInterface) {
    GCodeMM.call(this, documentInterface, camDocumentInterface);

    this.outputOffsetPath = true;
}

GCodeOffsetMM.prototype = new GCodeMM();
GCodeOffsetMM.displayName = "G-Code (Offset) [mm]";
GCodeOffsetMM.description = "Generic G-Code with nummerically calculated offsets for tool radius compensation";
