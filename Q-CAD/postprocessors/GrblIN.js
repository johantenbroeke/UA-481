 ...
 * Output in Inches.
 */
function GrblIN(documentInterface, camDocumentInterface) {
    ...
    // G70: Inch unit (might be supported or not)
...
GrblIN.prototype = new Grbl();
GrblIN.displayName = "GRBL (offset) [in]";
