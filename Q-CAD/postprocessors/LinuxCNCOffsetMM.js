...
function LinuxCNCOffsetMM(cadDocumentInterface, camDocumentInterface) {
...
LinuxCNCOffsetMM.prototype = new LinuxCNC();

LinuxCNCOffsetMM.displayName = "LinuxCNC (Offset) [mm]";
